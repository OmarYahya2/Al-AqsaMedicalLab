...
import { MapPin, Phone, Mail, Clock, Calendar, MessageSquare, NavigationIcon, Building } from "lucide-react"
                    ...
                    <form className="space-y-6">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input id="firstName" placeholder="أدخل اسمك الأول" className="text-right" />
                        </div>
                        <div>
                          <Label htmlFor="lastName" className="text-right block mb-2">اسم العائلة</Label>
                          <Input id="lastName" placeholder="أدخل اسم العائلة" className="text-right" />
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <Input id="phone" placeholder="أدخل رقم هاتفك" className="text-right" />
                      </div>
                      
                      <div>
                        <Label htmlFor="subject" className="text-right block mb-2">الموضوع</Label>
                        <Input id="subject" placeholder="أدخل موضوع الرسالة" className="text-right" />
                      </div>
